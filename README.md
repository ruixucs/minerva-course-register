...
- ⏱️ Check frequency changed from minutes to **seconds** (15-300s)
- 📊 Added **floating status panel** showing CRNs, attempt count, and countdown
...
**You need to keep the tab with the Add/Drop page open for the extension to work.**

## Credits

Original project by [Hanzi Li](https://github.com/hanzili/minerva-course-register)
